...
```{r fig8, fig.cap="Top Ten Counties with Power Plant Sites", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig9, fig.cap="Primary Fuel Category of Robeson County Power Plants", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig10, fig.cap="CO2 Equivalent Emissions from Electricity Generation in North Carolina", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig11, fig.cap="CO2 Equivalent Emissions from Power Plants (in tons) and Disadvantaged Communities in North Carolina", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig12, fig.cap="NOx Emissions from Power Plants (in tons) and Disadvantaged Communities in North Carolina", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig13, fig.cap="SO2 Emissions from Power Plants (in tons) and Disadvantaged Communities in North Carolina", fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
