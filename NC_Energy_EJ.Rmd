...
Although natural gas contributes the most to electricity capacity in North Carolina, the number of solar power plants in the state is notably high (Figure 2). This indicates that North Carolina likely hosts numerous, small solar power plants across the state. Solar power plants are small in capacity, but remain the most popular renewable resource in the state.
