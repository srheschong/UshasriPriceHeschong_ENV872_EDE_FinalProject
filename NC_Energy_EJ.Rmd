...
disadvantaged_map <- 
  mapview(EJ_NC_sf, zcol = 'Identified.as.disadvantaged',
        ...
        col.regions = disadvantaged_colors,
        na.color = "white")
...
Mapping NOx emissions along with counties reveals that counties with and without disadvantaged status face NOx emissions when located close to fossil fuel power plants. Examining correlation between county status and power plant location will reveal if power plants are disproportionately located close to disadvantaged communities. Given that natural gas and coal plants release high levels of NOx and carbon emissions, proximity to these power plants could impact public health outocmes.
...
mapview(EJ_NC_sf, zcol = 'Identified.as.disadvantaged',
        ...
        na.color = "white") +
  mapview(nc_plant_emissions,
        cex = "Plant annual SO2 emissions (tons)",
        zcol = "Plant primary fuel category",
        layer.name = "SO2 Emissions (Tons)")
