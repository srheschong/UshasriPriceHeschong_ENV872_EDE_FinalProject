...
```{r fig3, fig.cap="Power Plant Locations in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig4, fig.cap= "Power Plant Nameplate Capacity (MW) by Location in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig5, fig.cap="Disadvantaged Census Tracts in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig6, fig.cap="Disadvantaged Census Tracts and Power Plant Locations in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig7, Plant Primary Fuel Cateory and Capacity Plot 2, fig.cap ="Number of Power Plants by Fuel Type in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
#Find the frequency of each type of fuel category
plant_counts <- nc_plants %>%
  group_by(`Plant primary fuel category`) %>%
  summarize(Count = n())
...
```{r fig8, fig.cap="Top Ten Counties with Power Plant Sites", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig9, fig.cap="Primary Fuel Category of Robeson County Power Plants", echo=FALSE, message=FALSE, warning=FALSE}
