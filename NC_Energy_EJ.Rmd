...
date: "2024-12-12"
subtitle: "Duke University, Nicholas School of the Environment"
output:
...
subtitle: "Instructors: Professor Luana Lima and Professor John Fay"
subtitle: "ENVRION872: Environmental Data Exploration"
...
```{r fig2, fig.cap="Number of Power Plants in North Carolina by Fuel Type", fig.height=5, echo=FALSE}
...
Solar power plants are evenly throughout the state of North Carolina, depicted in Figure @ref(fig:fig3), except in Western North Carolina along the Appalachian range. In this mountainous region, hydro power plants are more common than solar power plants.
...
```{r fig3, fig.cap="Power Plant Locations in North Carolina", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
While the number of solar power plants is large, Figure @ref(fig:fig4) showcases that each solar plant contains a relatively small electricity generation capacity. The natural gas and coal power plants, though lower in number, producer a larger share of electric power in the state.


```{r fig4, fig.cap= "Power Plant Nameplate Capacity (MW) by Location in North Carolina", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig5, fig.cap="Disadvantaged Census Tracts in North Carolina", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig6, fig.cap="Disadvantaged Census Tracts and Power Plant Locations in North Carolina", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig8, fig.cap="Top Ten Counties with Power Plant Sites", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig9, fig.cap="Primary Fuel Category of Robeson County Power Plants", fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig10, fig.cap="CO2 Equivalent Emissions from Electricity Generation in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fig11, fig.cap="CO2 Equivalent Emissions from Power Plants (in tons) and Disadvantaged Communities in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
...
Mapping NOx emissions along with counties reveals that counties with and without disadvantaged status face NOx emissions when located close to fossil fuel power plants. In the map below (Figure @ref(fig:fig12)), the dark circles represent NOx emissions from power plant sites. Larger circles indicate a greater amount of NOx emissions in tons. Examining correlation between census tract disadvantaged status and power plant location will reveal if power plants are disproportionately located close to disadvantaged communities. Given that natural gas and coal plants release high levels of NOx and carbon emissions, proximity to these power plants could impact public health outcomes.


```{r fig12, fig.cap="NOx Emissions from Power Plants (in tons) and Disadvantaged Communities in North Carolina", echo=FALSE, message=FALSE, warning=FALSE}
