...
```{r CO2 Emissions 1, fig.cap="CO2 equivalent emissions from electricty fuel type in NC. Gas and coal are the only two types that produce CO2 emissions, warning=FALSE, with gas producing the most.", echo=FALSE}
...
```{r C02 emissions 2, fig.cap="Disadvantaged census tracts and power plant CO2 emissions (tons) in NC. The black circles represent emissions; the larger the circle, warning=FALSE, the greater the power plant's emissions.", echo=FALSE}
...
```{r NOx emissions, fig.cap="Disadvantaged census tracts and power plant NOx emissions (tons) in NC. The black circles represent emissions; the larger the circle, warning=FALSE, the greater the power plant's emissions.", echo=FALSE}
#Analyze NOx
...
```{r SO2 emissions, fig.cap="Disadvantaged census tracts and power plant SO2 emissions (tons) in NC. The black circles represent emissions; the larger the circle, warning=FALSE, the greater the power plant's emissions.", echo=FALSE}
#Analyze SO2
#EPA defines this as a dangerous pollutant for public health
