...
The EGRID 2022 data set provides information on electricity generation in the United States. The National Renewable Energy Labratory publishes this data to describe capacity and geographic distribution of different energy resources. The 2022 data is the most recent data (published in 2024), because it requires time to process and handle previous data in a workbook.
