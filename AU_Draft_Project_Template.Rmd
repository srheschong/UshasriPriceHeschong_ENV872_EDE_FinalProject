...
nc_energy_emissions <- nc_energy %>%
  group_by(`Plant primary fuel category`) %>% summarise(total_CO2e = sum(as.numeric(`Plant annual CO2 equivalent total output emission rate (lb/MWh)`)))
